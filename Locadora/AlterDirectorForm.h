...
namespace Locadora {
	...
	/// <summary>
	/// Summary for AlterDirectorForm
	/// </summary>
	public ref class AlterDirectorForm : public System::Windows::Forms::Form
	{
	public:
		AlterDirectorForm(void)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tbId->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &AlterDirectorForm::tbId_KeyPress);
			// 
			// label5
			// 
			...
			this->lbInfo->Location = System::Drawing::Point(542, 88);
			...
			this->tableLayoutPanel1->Location = System::Drawing::Point(12, 104);
			...
			this->btnCancel->Click += gcnew System::EventHandler(this, &AlterDirectorForm::btnCancel_Click);
			// 
			// btnSave
			// 
			...
			this->btnSave->Click += gcnew System::EventHandler(this, &AlterDirectorForm::btnSave_Click);
			// 
			// AlterDirectorForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(604, 146);
			...
			this->Name = L"AlterDirectorForm";
			this->Text = L"Locadora: Altera Diretor";
...
#pragma endregion
	...
	private: System::Void btnSave_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		if (String::IsNullOrEmpty(s_id) || String::IsNullOrEmpty(name))
		{
		...
		else
		{
			...
			{
				Director^ dir = gcnew Director(id, name);
				controller->alterDirector(dir);
